...
/**
 * Program designed to test ArrayIndexedCollection and LinkedListIndexedCollection classes.
 * 
 * @author Luka Grgić
 * @version 1.0
 */
public class ArrayAndLinkedCollectionsDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println(col.remove(new Integer(20))); // removes 20 from collection (at position 0).
		System.out.println(col2.remove(new Integer(20)));
	}
